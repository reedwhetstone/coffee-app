-- Enforce public catalog visibility for trusted v2 similarity RPCs when callers
-- should only see the public catalog contract (API keys and non-member viewers).
...
REVOKE EXECUTE ON FUNCTION find_similar_beans_v2(INT, FLOAT, INT, TEXT[], BOOLEAN, BOOLEAN) FROM PUBLIC, anon, authenticated;
...
GRANT EXECUTE ON FUNCTION find_similar_beans_v2(INT, FLOAT, INT, TEXT[], BOOLEAN, BOOLEAN) TO service_role;
