...
for (const invariant of [
	...
	'grant execute on function public.seal_supplier_observation_set',
	'freeze_market_index_cohort',
	'market cohorts must be inserted unfrozen',
...
for (const scenario of [
	...
	'service role seal rpc did not complete observation set',
