...
- Keep the response self-contained enough for both the dashboard and Cherry Runtime to consume the same structured evidence without reconstructing or re-ranking it in either client.
