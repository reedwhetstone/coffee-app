...
- **Work in Purveyors:** buyers and roasters use the public market, Parchment Intelligence, Ask Parchment, and Mallard Studio directly.
...
- Ask Parchment is already a shared AI workbench with entitlement-specific tools:
  - Intelligence unlocks sourcing, catalog, portfolio, price-index, and market-signal context.
  - Studio unlocks catalog, inventory, roast, tasting, and sales context.
  - Studio + Intelligence unlocks both context families.
...
- **Cherry:** potential coffee-domain model and reasoning layer strengthening multiple surfaces.
...
2. **Make AI concrete.** Show the questions Ask Parchment can investigate and the evidence or roaster records it can use. Do not market generic chat.
...
- Is Cherry a customer-facing identity, an internal capability owner, or simply implementation detail?
