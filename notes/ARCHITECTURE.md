...
- roast and sales data helpers that still write Supabase directly even though
  equivalent account-linked Parchment contracts now exist
...
overall rating without a direct Supabase write.
