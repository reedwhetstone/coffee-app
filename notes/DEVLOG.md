...
- [x] **Catalog Proof Summary Seed** - Initial app/API slice shipped in PR #327 with deterministic proof summaries for process, provenance, freshness, and pricing claims exposed through optional `/v1/catalog?include=proof` and public CoffeeCard trust badges; CLI proof output shipped separately in purveyors-cli PR #108. Plans: `notes/implementation-plans/2026-05-01-catalog-proof-summary-seed.md` and PR slice docs.
...
- [x] **Canonical Similarity API** - Shipped beta green-coffee similarity endpoints in PR #331 with entitlement hardening, mode overfetch fixes, classification filtering, and reverify docs. Plan: `notes/implementation-plans/2026-05-04-canonical-green-coffee-matching.md`, plus PR #331 docs.
