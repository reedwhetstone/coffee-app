...
- [ ] **Canonical Green Coffee Matching** - The beta `/v1/catalog/:id/similar` endpoint, member comparison UI, conservative threshold calibration, and bounded hard-gated `canonical-match-v1` response groups shipped in PRs #331, #332, #336, #347, and follow-up SQL fixes #348-#350. Next slices: CLI/agent adoption of grouped canonical/similar output, identity review foundation, scraper resolution pipeline, and canonical merged views. Programs: `notes/implementation-plans/2026-05-06-canonical-match-disambiguation-and-performance.md` and `notes/implementation-plans/2026-05-04-canonical-green-coffee-matching.md`.
- [ ] **Catalog Proof Coverage + Query Filters** - Turn shipped `proof-summary-v1` rows into a measurable intelligence surface with `GET /v1/catalog/proof-coverage`, then add capability-gated proof query filters for member sessions and paid API tiers. Plan: `notes/implementation-plans/2026-05-04-catalog-proof-coverage-query.md`.
