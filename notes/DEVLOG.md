...
## Priority 0: Current Product Priorities (reconciled May 7, 2026)
...
- [ ] **Canonical Green Coffee Matching** - The beta `/v1/catalog/:id/similar` endpoint, member comparison UI, conservative threshold calibration, bounded hard-gated `canonical-match-v1` response groups, SQL follow-up fixes, and tier-confidence cleanup shipped in PRs #331, #332, #336, #347, #348, #349, #350, and #351. Next slices: CLI/agent adoption of grouped canonical/similar output, identity review foundation, scraper resolution pipeline, and canonical merged views. Programs: `notes/implementation-plans/2026-05-04-canonical-green-coffee-matching.md`, `notes/implementation-plans/2026-05-06-canonical-match-disambiguation-and-performance.md`, and `notes/implementation-plans/2026-05-07-canonical-similarity-cli-agent-alignment.md`.
- [ ] **Catalog Proof Coverage + Query Filters** - Turn shipped `proof-summary-v1` rows into a measurable intelligence surface with `GET /v1/catalog/proof-coverage`, then add capability-gated proof query filters for member sessions and paid API tiers. Plans: `notes/implementation-plans/2026-05-04-catalog-proof-coverage-query.md` and `notes/implementation-plans/2026-05-07-proof-query-filter-contract.md`.
- [ ] **Purveyor Score Rollout Discipline** - Stored Purveyor Score fields, trigger/backfill migration, card hierarchy, methodology docs, migration-safety fixes, and tier-confidence cleanup shipped in PRs #345, #348, #349, and #351. Next product work: validate the migration/backfill path in production, keep score language pinned to metadata completeness rather than cup quality or supplier verification, and decide whether API/CLI score filters belong behind member/API capability gates after real catalog distribution is inspected.
...
- [ ] **API** - Add `GET /v1/catalog/proof-coverage` and proof query filters so process/provenance/freshness/pricing evidence quality becomes measurable before agents rely on it. Plan: `notes/implementation-plans/2026-05-04-catalog-proof-coverage-query.md`.
...
- `notes/implementation-plans/2026-05-04-catalog-proof-coverage-query.md` - Proof coverage endpoint and proof query filter plan
