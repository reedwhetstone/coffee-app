...
## Priority 0: Current Product Priorities (reconciled May 6, 2026)
...
- [ ] **Canonical Green Coffee Matching** - The beta `/v1/catalog/:id/similar` member/API endpoint, v2 similarity contract, and member comparison UI shipped in PRs #331 and #332. Next slices are CLI/agent alignment, threshold calibration, identity review queue, scraper resolution pipeline, and canonical merged-view work. Program: `notes/implementation-plans/2026-05-04-canonical-green-coffee-matching.md`.
...
- [ ] **Proof Passport Pilot Export** - coffee-scraper PR #245 added the current implementation plan for a private 100-row proof-passport pilot export built on the merged proof-readiness scorer from coffee-scraper PR #243. Next implementation: add `scripts/generate-proof-passport-pilot.ts`, fixture-backed sampling/output tests, and local-only JSON/Markdown artifacts without public proof claims. Plan: `../coffee-scraper/notes/implementation-plans/2026-05-04-proof-passport-pilot-export.md`.
...
- [ ] **API / Matching** - Extend the shipped beta `/v1/catalog/:id/similar` contract and member comparison UI into CLI/agent workflows, threshold calibration, identity review, scraper resolution, and canonical merged views. Keep legacy RPC compatibility debt explicit until callers migrate. Program: `notes/implementation-plans/2026-05-04-canonical-green-coffee-matching.md`.
