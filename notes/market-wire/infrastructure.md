...
_Status: Historical architecture recommendation. Not implementation authority._
_Companions: `notes/market-wire/research.md` (research package), `notes/market-wire/design.md` (product/pipeline design)_

> **Historical record:** This document preserves the original Market Wire
> infrastructure proposal. Current direction keeps the canonical edition in the
> coffee-app blog workflow and assigns exact shared delivery and source-capture
> contracts to their owning repos. Do not implement the schemas, routes, workers,
> or WP sequence below from this file. Use
