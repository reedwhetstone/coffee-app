...
| `brain/ideas/managing-agents-through-the-executive-layer.md`                                | External workspace idea source                       | Feeds human-agent context division, informed abstraction, and product-contact safeguards |
...
| What Should an Organization Refuse to Build?                            | `what-should-an-organization-refuse-to-build`      | 2026-07-17 | agentic-stack        | #480        | Clean        |
