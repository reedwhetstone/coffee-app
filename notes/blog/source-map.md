...
| `brain/ideas/cognitive-monorepo-continuous-project-conversation.md`                         | External workspace idea source                      | Feeds context garbage collection, intent transitions, and continuous-conversation architecture |
