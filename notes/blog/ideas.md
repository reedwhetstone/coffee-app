...
- [ ] The listing schema is the market: why a scraped catalog should become a publishing standard | Source: notes/big-ideas/2026-04-09-open-coffee-listing-standard.md | Pillar: api-architecture | Status: outlined | Outline: notes/blog/outlines/what-if-the-real-marketplace-is-the-listing-schema.md | Note: Picked because api-architecture is still the most underrepresented published pillar. Reframed as "What If the Real Marketplace Is the Listing Schema?" The angle: scraping is bootstrap and audit infrastructure, but the durable control point is the canonical listing contract suppliers publish into and buyers or agents act through.
