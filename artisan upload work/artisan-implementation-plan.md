...
1. **File Input Update** (Lines 1406-1412):
   ...
   <input type="file" accept=".alog.json,.json" onchange={handleArtisanFileSelect} class="..." />
   ```
...
export function formatTemperature(value: number, unit: 'F' | 'C', displayUnit?: 'F' | 'C'): string {
	const displayValue =
