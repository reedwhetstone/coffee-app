...
- the API dashboard for keys and usage
...
- any dashboard docs handoff pages such as `/api-dashboard/docs`
...
- Do not weaken API-key validation, rate limiting, or dashboard key management flows in doc-focused changes
