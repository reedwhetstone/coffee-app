...
export function checkRole(userRole: UserRole | UserRole[] | undefined, requiredRole: UserRole): boolean {
...
export function hasRole(userRole: UserRole | UserRole[] | undefined, targetRole: UserRole): boolean {
	if (!userRole) return false;
