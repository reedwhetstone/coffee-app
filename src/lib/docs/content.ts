		...
		items: [
			{
				slug: 'overview',
				title: 'Overview',
				summary: 'How the public API, internal app API, dashboard, and docs fit together.'
			},
			{
				slug: 'catalog',
				title: 'Catalog',
...
const docsPages: DocsPage[] = [
	{
		...
		title: 'API overview',
		summary:
			'Purveyors ships two API surfaces: a public API-key catalog feed and an internal session-auth app API.',
		eyebrow: 'Purveyors platform',
		intro: [
			'Purveyors has an external API for catalog consumers and a larger internal API that powers the web app. They share product concepts, but they do not share the same auth model or stability guarantees.',
			'The external contract today is the catalog feed at /api/catalog-api. The internal routes under /api/* support inventory, roasting, profit, chat, workspaces, Stripe, and dashboard flows for the first-party app.'
		],
		sections: [
			{
				title: 'Surface map',
				table: {
					...
					rows: [
						...
						['/api-dashboard/*', 'Web session', 'Keys, usage, account-aware docs', 'Dashboard UI'],
						[
							'/api/catalog',
			...
			},
			{
				...
				bullets: [
					...
					'Dashboard pages are authenticated web pages, not separate API-key endpoints.'
				],
				codeBlocks: [
					{
			...
			},
			{
				...
				bullets: [
					'/api is the marketing and getting-started page for the API product.',
					'/docs is the unified public docs home for both API and CLI documentation.',
					'/api-dashboard/docs is the authenticated handoff page that links your account state to the public docs, keys, and usage pages.'
				]
			},
			{
				...
				callout: {
					...
					body: 'Market analytics, roast CRUD, inventory CRUD, chat tools, and workspace routes are important platform capabilities, but they are still internal app surfaces. Document them clearly, but do not treat them as stable public API-key products yet.'
				}
			}
		],
		related: [
			...
			},
			{
				href: '/api-dashboard',
				label: 'API dashboard',
				description: 'Generate keys, inspect usage, and manage subscription-linked access.'
			},
			{
	...
	},
	{
		...
		intro: [
			'The public /analytics page exposes daily market intelligence without login and expands for authenticated users and ppi-member users. It is a product surface first, not yet a public API-key analytics product.',
		...
		sections: [
			{
				...
				bullets: [
					...
					'ppi-member users unlock spread mode, origin-level price index tables, and premium roadmap panels for longer-term trend detail.'
				]
			},
			{
	...
	},
	{
		...
		summary:
			'Status codes vary by surface. External API, dashboard pages, and internal routes fail differently by design.',
		...
		sections: [
			{
				...
				table: {
					...
					rows: [
						...
						[
							'303',
							'/api/docs or dashboard redirects',
							'Route is redirecting to the correct docs entry point'
						],
			...
			},
			{
				...
				bullets: [
					...
					'Dashboard pages are the best place to debug keys, usage, and plan limits because they expose account-aware context.'
				]
			}
		],
		related: [
	...
	},
	{
		...
		title: 'CLI overview',
		summary:
			'The Purveyors CLI is the terminal entry point for catalog queries, personal workflows, and agent-safe automation.',
