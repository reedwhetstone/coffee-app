						...
						>
							...
							>
								<path
									stroke-linecap="round"
									stroke-linejoin="round"
									d="M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5M10 11.25h4M3.75 7.5h16.5-1.25a.75.75 0 00.75-.75V5.625c0-.621-.504-1.125-1.125-1.125H4.125A1.125 1.125 0 003 5.625v1.5c0 .414.336.75.75.75z"
								/>
							</svg>
						</div>
						...
						>
							...
							>
								<path
									stroke-linecap="round"
									stroke-linejoin="round"
									d="M2.25 18L9 11.25l4.306 4.307a11.95 11.95 0 010 2.814l-5.814 5.814a2.25 2.25 0 01-3.182 0l-5.814-5.814a2.25 2.25 0 010-3.182L2.25 18z"
								/>
								<path
									stroke-linecap="round"
									stroke-linejoin="round"
									d="M11.25 9l3.5-3.5a2.25 2.25 0 113.182 3.182L11.25 15.25 9 13l2.25-2.25z"
								/>
							</svg>
						</div>
						Roast Anywhere
