...
<section class="relative overflow-hidden bg-gradient-to-br from-surface-canvas to-surface-panel">
	...
	>
		<div
			class="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-background-tertiary-light opacity-20 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]"
