 ...
 */
export function smoothData(data: TimeValuePoint[], windowSize: number): TimeValuePoint[] {
 ...
 */
export function findChargeTime(events: RoastEventEntry[], data: RoastPoint[]): number {
