<svelte:head>
	...
	<meta
		name="description"
		content="Parchment API docs now live under the unified /docs tree, with /v1/catalog as the stable public contract and /api/* documented as internal app routes."
	/>
</svelte:head>
...
>
	...
	<p class="mt-3 text-sm text-text-secondary-light">
		...
		>
		for the public /v1/catalog contract and the internal app route map.
	</p>
</div>
