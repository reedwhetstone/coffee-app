...
// Temporary raw-path adapter until the generated SDK release includes comparison discovery.
...
export const GET: RequestHandler = async (event) => {
	...
	const { data, error, response } = await get('/v1/price-index/comparisons', { params: { query } });
