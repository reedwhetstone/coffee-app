...
export const GET: RequestHandler = async (event) => {
	...
	const successorUrl = `https://api.purveyors.io/v1/procurement/briefs/${encodeURIComponent(id)}/matches`;
	return runProcurementProxyRoute(event, successorUrl, (e) => proxyBriefMatches(e, id));
};
