<div class="min-h-screen bg-surface-canvas">
	<div class="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
		...
		<div class="text-center">
			<h1 class="font-serif text-3xl font-medium tracking-tight text-ink sm:text-4xl">
				About Purveyors
			</h1>
		...
		<div class="mt-12 grid grid-cols-1 gap-y-12 lg:grid-cols-2 lg:gap-x-16">
			...
			<div class="space-y-12">
				<!-- Contact Information -->
				<div>
					<h2 class="text-2xl font-bold text-ink">Get in Touch</h2>
					...
					<div class="mt-8 space-y-6">
						...
						<div class="flex items-start">
							...
							<div class="ml-3">
								<p class="text-sm font-medium text-ink">Response Time</p>
								<p class="mt-1 text-sm text-muted">Typically within 24 hours</p>
							</div>
						</div>
						...
						<div class="flex items-start">
							...
							<div class="ml-3">
								<p class="text-sm font-medium text-ink">Best Times to Reach Me</p>
								<p class="mt-1 text-sm text-muted">Monday - Friday, 9AM - 5PM PST</p>
							</div>
						</div>
					</div>
				</div>
				...
				<!-- Open Source Project -->
				<div>
					<h2 class="text-2xl font-bold text-ink">Open Source</h2>
					<p class="mt-4 text-muted">
					...
					<div class="mt-8 space-y-6">
						...
						<div class="flex items-start">
							...
							<div class="ml-3">
								<p class="text-sm font-medium text-ink">Source Code</p>
								<p class="mt-1 text-sm text-muted">
									<a
						...
						<div class="flex items-start">
							...
							<div class="ml-3">
								<p class="text-sm font-medium text-ink">License</p>
								<p class="mt-1 text-sm text-muted">
			...
			<div>
				<div class="space-y-6">
					...
					<!-- Founder Bio -->
					<div class="text-center">
						<h3 class="text-xl font-bold text-ink">Reed Whetstone</h3>
						<p class="text-sm font-medium text-accent">Founder</p>
					</div>
