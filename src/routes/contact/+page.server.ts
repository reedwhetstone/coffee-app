...
export const load: PageServerLoad = async ({ url }) => {
	...
	const organizationData = {
		name: 'Purveyors',
		description:
			'Open source coffee platform built to democratize coffee sourcing and make roast management more accessible for hobbyist & SMB roasters.',
		founder: 'Reed Whetstone',
		foundingDate: '2024',
		mission:
			'Democratizing Coffee. Making specialty coffee sourcing and roast management more accessible through open source tools and normalized data.'
	};
