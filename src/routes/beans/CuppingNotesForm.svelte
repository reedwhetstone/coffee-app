...
<FormShell
	mode="card"
	title="Your Cupping Assessment"
	subtitle="Give an overall rating and rate each dimension from 1-5, add descriptive tags, and choose colors that represent your experience."
>
	{#snippet children()}
