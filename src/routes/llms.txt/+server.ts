...
- [Market Analytics](${baseUrl}/analytics): Live green coffee price trends by origin, processing method distribution, and origin price ranges. Free market snapshot with deeper access through Parchment Intelligence.
